...
class PlaidClient:
    ...
    def create_link_token(self, user_id: str, client_name: str = "Populus") -> str:
    ...
    def get_transactions(self, access_token: str, start_date: date= date(2024, 1, 1), end_date: date = date.today()) -> list:
        """ Fetches transactions for the given access token. You can specify a date range, but it defaults to the current year.
        This is an example of how you might use the access token to get transactions after the user has connected their bank account."""
