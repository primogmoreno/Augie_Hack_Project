  ...
  return (
    <div
      ...
      style={{
        ...
        padding: '12px 14px',
        borderRadius: 12,
        border: isActive ? `2px solid ${category.borderColor}` : '0.5px solid var(--border-1)',
    ...
    >
      <div style={{
        ...
        height: 36,
        borderRadius: 9,
        background: isActive ? category.borderColor + '22' : 'var(--ink-50)',
        display: 'flex',
        alignItems: 'center',
      ...
      <div style={{
        ...
        <div style={{
          height: '100%',
          width: `${pct}%`,
          background: isActive ? category.borderColor : 'var(--teal-500)',
          borderRadius: 2,
