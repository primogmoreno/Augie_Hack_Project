...
export default function Analyze() {
  ...
  useEffect(() => {
    const cached = cacheGet("spending_analysis");
    if (cached) {
      setIsConnected(true);
      setTxCount(cached.txCount);
      setAnalysis(cached.analysis);
      return;
    }

    api
      .get("/transactions?days=90")
      .then(({ data }) => {
        setIsConnected(true);
        if (!data.pending) setTxCount(data.transactions?.length ?? 0);
      })
      .catch((err) => {
        if (err.response?.status === 401) setIsConnected(false);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <TopBar
        ...
        subtitle={
          isConnected
            ? "AI-powered breakdown of your transactions"
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Connect your bank and Gemini will read your last 90 days of
                    transactions — explaining exactly where your money is going,
              ...
              >
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      Gemini reads your last 90 days of transactions and
                      explains your spending patterns in plain English — no
                      jargon, no judgment.
                      {txCount !== null && (
                        <span
                    ...
                    {stage === "error" && (
                      ...
                      >
                        ...
                        >
                          Something went wrong. Make sure your bank account is
                          connected and the server is running.
                        </p>
                        <Button
                          variant="secondary"
                          size="sm"
